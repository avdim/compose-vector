...
//        .notify(null);
  ...
  private static final class MacClipboardHandler extends ClipboardHandler {
    ...
    public void setContent(@NotNull final Transferable content, @NotNull final ClipboardOwner owner) {
      if (ClipboardConfig.getUseMacNativeClipboard() && content.isDataFlavorSupported(DataFlavor.stringFlavor)) {
        try {
...
//    }
  ...
  static final class HeadlessClipboardHandler extends ClipboardHandler {
    ...
    @Override
    public @NotNull
    Object getData(@NotNull DataFlavor dataFlavor) throws IOException, UnsupportedFlavorException {
