...
public class SuspendingPointerInputFilter2(
  ...
  PointerInputScope,
    ...
    override fun onPointerEvent(
      ...
      bounds: IntSize
        ...
        println("pointerEvent.mouseEvent?.modifiersEx: ${pointerEvent.mouseEvent?.modifiersEx}")
    ...
    private inner class PointerEventHandlerCoroutine<R>(
    ...
    ) : AwaitPointerEventScope, Density by this@SuspendingPointerInputFilter2, Continuation<R> {
        ...
        override val currentEvent: PointerEvent
            get() = this@SuspendingPointerInputFilter2.currentEvent
        override val size: IntSize
            get() = this@SuspendingPointerInputFilter2.boundsSize
        override val viewConfiguration: ViewConfiguration
            get() = this@SuspendingPointerInputFilter2.viewConfiguration
        override val extendedTouchPadding: Size
            get() = this@SuspendingPointerInputFilter2.extendedTouchPadding
